...
def callback():
    ...
    # Gửi mail
    recipients = [
        "xxxxxxxxxxxxxxxxxx.onmicrosoft.com", "xxxxxxxxxxxxxxxxx.onmicrosoft.com",
        "xxxxxxxxxxxx.onmicrosoft.com", "xxxxxxxxxxxxxx.onmicrosoft.com",
        "xxxxxxxxx.onmicrosoft.com"
    ]
    mail_payload = {
        "message": {
